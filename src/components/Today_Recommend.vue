<template>
    <div class='mod-albums'>
        <div class="hd log url">
            <h2>{{ title }}</h2>
            <router-link tag="div" :to="{ name:'MoreList',params:{type:musictype,title:title} }">更多</router-link>
        </div>
        <div class="container">
            <div class="gallery">
                <div class="scroller">
...
export default {
    ...
    mounted(){
        var url = this.HOST + '/v1/restserver/ting?method=baidu.ting.billboard.billList&type='+this.musictype+'&size=6&offset=0'
        this.$axios.get(url)
        .then(res => {
